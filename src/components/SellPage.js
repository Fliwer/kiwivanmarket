        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <form onSubmit={handleSubmit}>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
              ...
              {/* Contact Section — how buyers reach you */}
              <div className="mt-8 p-6 bg-white border-2 border-gray-100 rounded-3xl shadow-sm">
                <div className="flex items-center mb-4">
                  <label className="text-base font-bold text-gray-800 flex items-center gap-2">
                    <span className="text-xl">{"💬"}</span> How buyers contact you
                  </label>
                </div>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Phone Number <span className="font-normal text-gray-400">(optional — for calls)</span>
                  </label>
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Buyers can call you directly from the listing.
                  </p>
                </div>
              </div>
